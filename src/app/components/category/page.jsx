    ...
    return (
        <Box sx={{
            ...
            <Box sx={{ flex: 1 }}>
                ...
                >
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nemo, eos fugit officiis error ipsum,
                    dolor ducimus nam ratione nulla deleniti inventore blanditiis.
                </Typography>
                    ...
                    {[
                        ...
                        >
                            ...
                            <Box sx={{ flex: 1 }}>
                                ...
                                <Typography
                                    variant="body2"
                                    sx={{ color: 'gray', fontSize: { xs: '0.8rem', md: '.8rem' } }}
                                >
                                    {item.body}
                                </Typography>
                            </Box>
